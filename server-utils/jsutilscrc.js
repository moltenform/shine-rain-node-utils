/// content-beyond-this-point-is-shared-with-server
...
var Tb = TT[10],
    ...
    Te = TT[13],
    Tf = TT[14];
export function crc32_bstr(bstr /*:string*/, seed /*:?CRC32Type*/) /*:CRC32Type*/ {
    var C = seed /*:: ? 0 : 0 */ ^ -1;
...
export function crc32_str(str /*:string*/, seed /*:?CRC32Type*/) /*:CRC32Type*/ {
    var C = seed /*:: ? 0 : 0 */ ^ -1;
